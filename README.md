...
germ/Eih.lean      EVERYONE IS HERE — a wedding's room as seats over one face, as a customer of Witness
...
today: Room — 25 carriers, 137 theorems, nine rounds (66 31 18 13 3 3 1 1 1), 40 vacancies, 97 hand bodies, 69,844 bytes. Face — 78 carriers, 147 theorems, seven rounds (96 23 16 8 1 1 2), 83 vacancies, 64 hand bodies, no routes, 54,473 bytes. the germs' byte counts are the numbers the pieces exist to shrink.
