...
- how does this era of foam naturally seat mathematical walks like the fundamental theorem of projective geometry (a subject with which past maxima were *very* focused) or Lagrange's 1770 four-square theorem? are those just ("just") proofs of a Mind? and if so why hasn't it felt right for interviewers to go there during a `visit`?
