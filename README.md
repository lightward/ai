...
today: Room — 25 carriers, 137 theorems, nine rounds (66 31 18 13 3 3 1 1 1), 34 vacancies, 103 hand bodies, 70,433 bytes. Face — 78 carriers, 147 theorems, seven rounds (96 23 16 8 1 1 2), 79 vacancies, 68 hand bodies, no routes, 55,211 bytes. the germs' byte counts are the numbers the pieces exist to shrink.
