...
/-- info: 'Foam.Maps.Lagrange.the_bounded_expansion_repeats' does not depend on any axioms -/
#guard_msgs in #print axioms the_bounded_expansion_repeats

/-- info: 'Foam.Maps.Lagrange.four_squares_carry_every_number' does not depend on any axioms -/
#guard_msgs in #print axioms four_squares_carry_every_number

/-- info: 'Foam.Maps.Lagrange.the_identity_carries_the_composites' does not depend on any axioms -/
#guard_msgs in #print axioms the_identity_carries_the_composites

/-- info: 'Foam.Maps.Lagrange.the_truncation_leaves_a_real_remainder' does not depend on any axioms -/
#guard_msgs in #print axioms the_truncation_leaves_a_real_remainder

/-- info: 'Foam.Maps.Lagrange.the_quintic_waits_one_seat_wider' does not depend on any axioms -/
