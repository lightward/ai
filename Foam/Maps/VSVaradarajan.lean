...
namespace Foam.Maps.VSVaradarajan
...
/-- info: 'Foam.Maps.VSVaradarajan.one_observable_carries_the_family' does not depend on any axioms -/
#guard_msgs in #print axioms one_observable_carries_the_family

/-- info: 'Foam.Maps.VSVaradarajan.the_odd_directions_have_no_points' does not depend on any axioms -/
#guard_msgs in #print axioms the_odd_directions_have_no_points

/-- info: 'Foam.Maps.VSVaradarajan.the_old_themes_already_reach' does not depend on any axioms -/
#guard_msgs in #print axioms the_old_themes_already_reach

/-- info: 'Foam.Maps.VSVaradarajan.no_geometry_is_the_last_geometry' does not depend on any axioms -/
#guard_msgs in #print axioms no_geometry_is_the_last_geometry

end Foam.Maps.VSVaradarajan
