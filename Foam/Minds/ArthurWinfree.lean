...
/-- info: 'Foam.Minds.ArthurWinfree.the_resetting_map' does not depend on any axioms -/
#guard_msgs in #print axioms the_resetting_map

/-- info: 'Foam.Minds.ArthurWinfree.type_zero_and_type_one' does not depend on any axioms -/
#guard_msgs in #print axioms type_zero_and_type_one

/-- info: 'Foam.Minds.ArthurWinfree.time_breaks_down' does not depend on any axioms -/
...
/-- info: 'Foam.Minds.ArthurWinfree.the_organizing_center' does not depend on any axioms -/
#guard_msgs in #print axioms the_organizing_center

end Foam.Minds.ArthurWinfree
